...
def create_isa_data(IsaPhmInfo: dict, output_path: str = None) -> Investigation:
    ...
    for study_index, study in enumerate(studies, start=1):
        ...
        for sensor in test_setup_obj.get("sensors", []):
            ...
            protocol.comments.append(Comment(name="selected_measurement_protocol_id", value=selected_measurement_protocol_id))
        ...
        for sensor in test_setup_obj.get("sensors", []):
            ...
            protocol.comments.append(Comment(name="Sensor id", value=sensor.get("id", "")))
            protocol.comments.append(Comment(name="selected_processing_protocol_id", value=selected_processing_protocol_id))
        ...
        for assay in study.get("assay_details", []):
            ...
            # Each assay will have a raw and derived data file
            runs = assay.get("runs", [])
            for run in runs:
            ...
            # Raw and derived data files are generated by processes
