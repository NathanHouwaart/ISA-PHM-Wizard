            ...
            <div className='bg-gray-50 p-3 border-gray-300 border rounded-lg pb-2 relative'>
                ...
                {selectedTestSetupId && sensors.length === 0 && (
                    <WarningBanner type="info">
                        <strong>No sensors in test setup.</strong> The selected test setup must contain one or more sensors to define measurement protocols. Add sensors to your test setup or select a different one.
                    </WarningBanner>
                )}
