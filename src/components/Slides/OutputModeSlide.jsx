    ...
    <div ref={combinedRef}>
      ...
      <div className="bg-gray-50 p-3 border-gray-300 border rounded-lg pb-2 relative space-y-4">
        ...
        {studiesWithMode.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_minmax(0,1fr)] gap-4 min-h-[45vh] lg:h-[45vh] lg:overflow-hidden">
            <div className="hidden lg:flex h-full bg-white border border-gray-300 rounded-2xl p-4 flex-col min-h-0 shadow-md">
              <Heading3 className="text-lg text-gray-900">Studies</Heading3>
              <Paragraph className="text-xs text-gray-500 mt-1 mb-2">
                      ...
                      <TooltipTrigger asChild>
                        ...
                        >
                          <div className="flex flex-col gap-1">
                            ...
                            <Paragraph className={`text-xs ${isActive ? 'text-blue-100' : 'text-gray-600'}`}>
            ...
            <div className="bg-white border border-gray-300 rounded-2xl p-4 lg:p-5 shadow-sm flex flex-col min-h-0">
