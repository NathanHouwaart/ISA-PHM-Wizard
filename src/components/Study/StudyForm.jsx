    ...
    <div className="bg-white rounded-lg shadow-lg border border-gray-300 max-h-[90vh] overflow-y-auto">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gray-50 rounded-lg space-y-1 pt-2">
            <FormField onBlur={handleChange} label="Title" type='text' placeholder="Study Title" example="eg. BPFO Fault Severty 1 100%" explanation={"Title of the study"}/>
            <FormField label="Description" type='textarea' placeholder="Study Description" example="eg. BPFO Fault Severty 1 100%" explanation={"Title of the study"}/>
