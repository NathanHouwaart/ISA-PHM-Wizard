    ...
    return (
        <GlobalDataProvider>
            <div ref={combinedRef}>
                ...
                <div
                    className={`rounded transition-opacity overflow-hidden duration-500 ease-in-out ${
                        value ? "opacity-100" : "opacity-0 max-h-0"
                    }`}
                >
                    <Collection
                        onHeightChange={() => {}}
                ...
                <div
                    className={`transition-opacity overflow-hidden duration-500 ease-in-out ${
                        value ? "opacity-0 max-h-0" : "opacity-100"
                    }`}
                >
                    <StudyTable
                        ref={ref}
