    ...
    <PageWrapper widthClass="max-w-7xl">
      <div className="space-y-8">
        <header className=" text-center">
            <div className="py-8">
              <Heading1 className="text-5xl font-extrabold leading-tight">Welcome to the ISA-PHM input Wizard</Heading1>
              <Paragraph className="text-gray-600 mt-4 text-lg">A lightweight toolkit to create metadata for PHM experiments, and map and export these to ISA-PHM format.</Paragraph>
            </div>
        </header>
        ...
        <main>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-2">
            ...
            <Link to="/testsetups" className="block bg-white rounded-2xl shadow-lg hover:shadow-xl transition p-8 border border-gray-200 h-full">
              ...
              <Paragraph className="text-sm text-gray-600 mt-3">Create or select test setups used in PHM experiments.</Paragraph>
            </Link>
            ...
            <Link to="/isaquestionnaire" className="block bg-white rounded-2xl shadow-lg hover:shadow-xl transition p-8 border border-gray-200 h-full">
              ...
              <Paragraph className="text-sm text-gray-600 mt-3">Open the ISA-PHM questionnaire form to translate experiment metadata to ISA-PHM format.</Paragraph>
            </Link>
          </div>
        </main>
